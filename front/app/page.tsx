          ...
          <div className="divide-y divide-white">
            <div className="flex p-5">
              ...
              <div className="flex flex-col ml-3 my-auto">
                <div className="font-medium text-md">Support</div>
              </div>
            </div>
            ...
            <div className="p-5">
              <div className="flex w-full">
                <input className="w-full outline-none border border-gray-200 px-3 py-1.5 rounded-l-md" placeholder="Type message here..."/>
                  <button type="button" className="bg-[#333333] px-2.5 rounded-r-md">
